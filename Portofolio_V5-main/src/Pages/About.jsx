...
const AboutPage = () => {
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    // Kita gunakan data lokal karena Supabase sudah dimatikan
    const projectsCount = 4; // Berdasarkan jumlah project Anda
    const certificatesCount = 1; // Berdasarkan jumlah sertifikat

    // Perhitungan pengalaman sejak mulai kuliah (2023)
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              Saya Putra, mahasiswa program studi Teknik Informatika di Universitas Al Azhar Indonesia. Memiliki minat kuat di bidang integrasi teknologi khususnya Data Analyst, Web Developer, dan Artificial Intelligence. Berpengalaman memimpin sebagai Wakil Ketua Himpunan Mahasiswa, saya terbiasa bekerja dalam tim, mengelola proyek, dan memecahkan masalah dengan solusi kreatif berbasis data.
            </p>

            {/* Education Section */}
            <div className="space-y-4 text-left" data-aos="fade-right" data-aos-duration="1600">
              <h3 className="text-xl font-semibold text-white">Education</h3>
              <div className="bg-white/5 p-4 rounded-xl border border-white/10 hover:border-white/20 transition-all">
                <h4 className="text-lg font-bold text-[#a855f7]">Universitas Al Azhar Indonesia</h4>
                <p className="text-gray-300">Bachelor of Computer Science (2023 - 2027)</p>
              </div>
            </div>

            {/* Organization Section */}
            <div className="space-y-4 text-left" data-aos="fade-right" data-aos-duration="1700">
              <h3 className="text-xl font-semibold text-white">Organization Experience</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-white/5 p-4 rounded-xl border border-white/10 hover:border-white/20 transition-all">
                  <h4 className="text-lg font-bold text-[#6366f1]">Campus Committee</h4>
                  <p className="text-gray-300 text-sm">Mentor PKKMB (Aug - Sep 2025)</p>
                </div>
                <div className="bg-white/5 p-4 rounded-xl border border-white/10 hover:border-white/20 transition-all">
                  <h4 className="text-lg font-bold text-[#6366f1]">BEM FST</h4>
                  <p className="text-gray-300 text-sm">Mentor Division (Nov - Dec 2025)</p>
                </div>
              </div>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full mt-6">
              <a href="/Putra_Universitas Al Azhar Indonesia_CV.pdf" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
