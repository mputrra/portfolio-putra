...
// --- DATA PROYEK (Sama dengan di Portofolio.jsx, tapi dengan tambahan Fitur) ---
const localProjects = [
  {
    id: 1,
    ...
    Github: "https://github.com/mhmmdputraa/Mental-Health-App",
    TechStack: ["Flutter", "Dart", "Firebase", "GetX"],
    Features: ["Daily Mood Tracking", "Analytics Dashboard", "User Authentication", "Daily Journaling"]
  },
  {
    id: 2,
    ...
    Github: "https://github.com/mhmmdputraa/AI-Sentiment",
    TechStack: ["Python", "TensorFlow", "Flask", "React"],
    Features: ["Real-time Text Analysis", "Deep Learning Model Integration", "Interactive UI", "REST API Endpoint"]
  },
  {
    id: 3,
    Img: "/pos_system.png",
    ...
    Github: "https://github.com/mhmmdputraa/Coffee-POS",
    TechStack: ["Laravel", "PHP", "MySQL", "Bootstrap"],
    Features: ["Inventory Management", "Transaction Processing", "Sales Reporting", "Employee Shift Management"]
  }
];
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // Kita ambil data dari localProjects yang ada di atas, BUKAN dari localStorage
